  ...
  return (
    ...
    <div className="testimonial-container">
        ...
        <h2>AUTHENTIC STORIES, REMARKABLE CHANGE</h2>
         <p>Discover how DCC revolutionizes businesses with outstanding UX design, innovative web development, advanced product optimization, and committed ongoing support</p>
        </div>
